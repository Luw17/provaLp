...
{
    fetch('https://https://prova-lp.vercel.app/body-builder/buscar/'+cpf,{
            method: 'GET',
            headers: {
...
{
    fetch('https://https://prova-lp.vercel.app/body-builder/'+cpf ,{
        method: 'DELETE',
        headers: {
            'Content-type': 'application/json'
        },
...
function send()
{
    ...
    if(alt)
    {
        ...
        fetch('https://https://prova-lp.vercel.app/body-builder',{
            method: 'POST',
            headers: {
                'Content-type': 'application/json'
            },
...
function pesquisar()
{
    ...
    fetch('https://https://prova-lp.vercel.app/body-builder/b/'+texto,{
        method: 'GET',
        headers: {
            'Content-type': 'application/json'
        },
...
function carregarAcademias()
{
    ...
    academias.innerHTML = ''; 
    fetch('https://https://prova-lp.vercel.app/gym',{
        method: 'GET',
        headers:{
            'Content-type':'application/json'
        },
...
function carregarEstilos()
{
    ...
    styles.innerHTML = ''; 
    fetch('https://https://prova-lp.vercel.app/style',{
        method: 'GET',
        headers:{
            'Content-type':'application/json'
        },
